...
- Main implementation plan: `context/plans/done/plan-add-hydra-quantization-granularity-control.md`
...
- Subtask spec: `context/tasks/done/add-hydra-quantization-granularity-control/subtask-001-101-define-granularity-vocabulary.md`
...
- Subtask spec: `context/tasks/done/add-hydra-quantization-granularity-control/subtask-001-102-add-hydra-quant-granularity-configs.md`
...
- Subtask spec: `context/tasks/done/add-hydra-quantization-granularity-control/subtask-001-103-implement-quant-cfg-overlays.md`
...
- Subtask spec: `context/tasks/done/add-hydra-quantization-granularity-control/subtask-001-104-wire-overlays-into-hydra-runner.md`
...
- Subtask spec: `context/tasks/done/add-hydra-quantization-granularity-control/subtask-001-105-update-output-naming-for-sweeps.md`
...
- Subtask spec: `context/tasks/done/add-hydra-quantization-granularity-control/subtask-001-106-add-tests-docs-and-smoke-sweeps.md`

### TODOs

- [x] Job-001-101: Complete subtask 1.1: Define granularity vocabulary and ModelOpt mapping (including Qwen3 recipe match).
- [x] Job-001-102: Complete subtask 1.2: Add Hydra `quant_granularity` config group with initial overlay options.
- [x] Job-001-103: Complete subtask 1.3: Implement ModelOpt quant_cfg overlay + normalization helper.
- [x] Job-001-104: Complete subtask 1.4: Wire overlays into the Qwen3 Hydra runner and record them in manifests.
- [x] Job-001-105: Complete subtask 1.5: Update output naming for collision-free multirun sweeps.
- [x] Job-001-106: Complete subtask 1.6: Add unit tests, docs, and smoke multirun examples.
