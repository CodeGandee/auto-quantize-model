...
Create a report summarizing the AutoQuant FP8 scheme experiments for Qwen2.5-VL-3B, including settings used, per-scheme quantization coverage, quality notes, and vLLM compatibility results. This subtask focuses on documentation rather than new code.
...
- [ ] Job-004-106-003 For each scheme, document the AutoQuant settings, quantization coverage (e.g., approximate fraction of LM blocks quantized), and any qualitative quality notes (if available).
