...
- [ ] Job-001-102-001 Decide preprocessing details (RGB/BGR, scale, letterbox padding color) and make it shared between calibration and evaluation.
- [ ] Job-001-102-002 Implement calibration tensor generation from `datasets/quantize-calib/quant100.txt` with output shape `[N, 3, 640, 640]` (float32).
- [ ] Job-001-102-003 Implement YOLOv10m ONNX COCO evaluation:
...
- [ ] Job-001-102-004 Run a **medium** baseline eval (100 images) and save metrics + latency stats under `tmp/`.
