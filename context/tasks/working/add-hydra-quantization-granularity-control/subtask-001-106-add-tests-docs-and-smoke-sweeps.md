...
- [ ] Job-001-106-001 Add unit tests for the overlay helper (happy-path and invalid overlays).
- [ ] Job-001-106-002 Add unit tests for output naming helpers (tmp + publish) to ensure granularity is included and stable.
- [ ] Job-001-106-003 Update `models/qwen3_vl_4b_instruct/layer-analysis/README.md` with:
...
- [ ] Job-001-106-004 Run a tiny smoke sweep (e.g., 2 quant pairs × 2 granularities × `dataset.size=small`) and confirm:
  - runs complete
