...
# Quantize Qwen2.5-VL-3B-Instruct to W8A8 (INT8 SmoothQuant) with NVIDIA ModelOpt,
...
#   - Applies INT8 SmoothQuant (`qformat=int8_sq`) to effectively obtain W8A8
#     quantization for the language model component
#   - Exports a quantized HF checkpoint under:
#       models/qwen2_5_vl_3b_instruct/quantized/w8a8_int8_sq_coco2017
#
# Usage:
#   pixi run bash scripts/qwen/quantize_qwen2_5_vl_3b_w8a8_coco2017.sh
...
EXPORT_PATH="${REPO_ROOT}/models/qwen2_5_vl_3b_instruct/quantized/w8a8_int8_sq_coco2017"
...
echo "Quantizing Qwen2.5-VL-3B-Instruct with ModelOpt HF PTQ..."
...
echo "Done. Quantized Qwen2.5-VL-3B-Instruct exported to:"
echo "  ${EXPORT_PATH}"
